...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pagina1.css') }}">
</head>
<body>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">no FUNCIONA</a></li>
...
<div class="toast" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  <div class="toast-body">
    Bienvenido al sitio de videojuegos.
  </div>
  
</div>
<h1>Bienvenido Jugador</h1>
<h2>Aqui encontraras videojuegos para todo los gustos</h2>
